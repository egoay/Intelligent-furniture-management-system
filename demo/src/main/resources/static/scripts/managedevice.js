document.addEventListener('DOMContentLoaded', function () {
    ...
    async function removeDevice(row, room, name) {//
        var Data = {
            room: room,
            name: name
        };
    ...
    async function cellChange(row, line, newName, room, name, type) {
        var Data = {
            room: room,
            name: name,
            type, type
    ...
    manageDeviceseachbutton.addEventListener('click', function (event) {//
